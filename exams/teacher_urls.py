...
urlpatterns = [
    ...
    path(
        "teacher/exams/<int:exam_id>/delete/",
        tv.exam_delete,
    ...
    path(
        "teacher/exams/<int:exam_id>/attempts/<int:attempt_id>/",
        tv.attempt_detail,
    ...
    # Questions
    path(
        "teacher/exams/<int:exam_id>/questions/new/",
        tv.question_create,
        name="teacher_question_create",
    ),
    path(
        "teacher/exams/<int:exam_id>/questions/<int:question_id>/edit/",
        tv.question_edit,
        name="teacher_question_edit",
    ),
    path(
        "teacher/exams/<int:exam_id>/questions/<int:question_id>/delete/",
        tv.question_delete,
